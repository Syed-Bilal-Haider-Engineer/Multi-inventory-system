...
const Input = ({ htmlFor, visible, label, type, name, value, required, ...rest }) => {
  let inputClassName = 'appearance-none block text-gray-800 w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-400 focus:border-blue-500 sm:text-sm';
  if (type === 'checkbox') {
